                    ...
                    <div class="sidebar-profile">
                        <div class="position-relative">
                            <div class="profile-img1 d-flex justify-content-center overflow-hidden">
                                <img src="{{asset('frontend')}}/assets/images/profile.png" alt="user" class="" />
                            </div>
                    ...
                    <div class="menu-list">
                        <ul class="d-flex flex-column gap-3">
                            <li class="rounded-3 {{ request()->routeIs('home') ? 'bg1-color' : '' }}">
                                <a href="{{ route('home') }}" class="d-flex align-items-center gap-2 n5-color fs-eight px-3 py-2">
                                    <i class="ph ph-user fs-six"></i> About Me
                                </a>
                            </li>
                            ...
                            <li class="rounded-3 {{ request()->routeIs('services') ? 'bg1-color' : '' }}">
                                <a href="{{ route('services') }}" class="d-flex align-items-center gap-2 n5-color fs-eight px-3 py-2">
                                    <i class="ph ph-briefcase fs-six"></i>Services & Pricing
                                </a>
                            </li>
                            ...
                            <li class="rounded-3 {{ request()->routeIs('contact') ? 'bg1-color' : '' }}">
                                <a href="{{ route('contact') }}" class="d-flex align-items-center gap-2 n5-color fs-eight px-3 py-2"><i class="ph ph-envelope fs-six"></i>Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <a href="{{ route('contact') }}" class="primary-btn fw-medium px-3 px-md-6 py-2 py-md-4 rounded-pill d-flex align-items-center gap-2 mx-auto">
