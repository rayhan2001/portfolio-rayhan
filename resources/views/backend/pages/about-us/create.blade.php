            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('about-us.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-4">
                                <label for="experience" class="form-label">Work Experience</label>
                                <input type="number" class="form-control" id="experience" name="year_of_experience">
                            </div>

                            <div class="col-md-4">
                                <label for="completed_projects" class="form-label">Project Complete</label>
                                <input type="number" class="form-control error" id="completed_projects" name="project_completed">
                            </div>
